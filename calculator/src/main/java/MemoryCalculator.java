...
public class MemoryCalculator {
    public static void main(String[] args) {
        ...
        double memory = 0; // Initialize memory to zero

        System.out.println("Welcome! This is a calculator with memory functionality.");
        ...
        while (true) {
            ...
            System.out.println("7. Store to Memory");
            System.out.println("8. Recall from Memory");
            System.out.print("Enter the operation (1/2/3/4/5/6/7/8): ");
            int choice = getValidChoice(reader, 1, 8);
            ...
            switch (choice) {
                ...
                case 7:
                    ...
                    continue;
                case 8:
                    result = memory; // Recall the value from memory
                    System.out.println("Value recalled from memory.");
                    break;
                default:
